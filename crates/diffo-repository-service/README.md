...
mutations so repository reads cannot race commands. Typed operation prompts carry the
active command identifier and answers bypass the blocked worker lane. Cancelled
commands return a post-operation snapshot. Snapshots,
