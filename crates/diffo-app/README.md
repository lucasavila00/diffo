...
results, and the single active modal slot. Searchable checkout and activity modals use
that slot without activities coordinating with one another. Passive update discovery
uses a persistent toast and never takes focus.
