...
- [AI commits](ai-commits.md) describes commit-message generation and its safety
  boundaries.
- [AI Review](ai-review.md) describes guided diff review and its interaction
  with staging and commits.
...
- `diffo-app::review`: guided AI review state, navigation, and drawing.
