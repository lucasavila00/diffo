...
pub(super) fn range_is_covered(coverage: &[LineRange], needed: Option<LineRange>) -> bool {
...
pub(super) fn merge_coverage(coverage: &mut Vec<LineRange>, incoming: Vec<LineRange>) {
...
pub(super) fn retain_covered_styles(cache: &mut HighlightCache) {
