...
files, and performs staging, safe branch checkout, commit, fetch, and sync operations.
...
sync never creates a merge commit or force-pushes. The resulting state and errors use
