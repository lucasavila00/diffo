...
worker. Review owns explicit AI generation, its ordered review steps, and navigation while
...
modals use that slot without activities coordinating with one another. Passive update
discovery uses a persistent toast and never takes focus.
