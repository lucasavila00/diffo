...
Diff and Explorer duplicate picker state, input, rendering, scrolling, and menus.
...
- Tree. Explorer creates one instance. The picker owns disclosure and indentation.
...
- Tests cover both modes, independent offsets, menus, actions, bounds, and uppercase.
