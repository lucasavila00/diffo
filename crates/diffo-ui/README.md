...
insets, gaps, and overlay bounds. It also owns the shared command palette, file
picker, and read-only text view. Callers own command execution, file activation,
