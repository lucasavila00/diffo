...
It collects repository snapshots, discovers local and remote branches, loads Explorer
files, and performs staging, safe branch checkout, commit, and network operations. The
resulting state and errors use the transport-neutral types from `diffo-core`. Network operations expose only typed,
